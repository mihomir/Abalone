...
import javax.swing.*;
public class BestMoveListener extends AbstractAction{
	Game game;
	GameController gc;
	AI ai;
	public BestMoveListener(GameController gamec){
		gc=gamec;
		game=gc.get_game();
//		game.change_player();
...
//		}
		if (answer==JOptionPane.NO_OPTION || answer==JOptionPane.CLOSED_OPTION){
			...
			gc.show_win_game();
			game.change_player();
			if (game.get_players().get_current().get_type()==1) {computer_move(dba);}
		}
...
//		Game game = g;
		AI Iai = new AI(game, game.get_current_player());
//		System.out.println("COMPLIST: AI is player: " + ai.get_player());
//		System.out.println("COMPLIST: Current player before AI searches for move: " + game.get_current_player());
		Move m = Iai.get_best_move(Iai.generate_moves());
//		System.out.println("COMPLIST: Current player after AI searches for move: " + game.get_current_player());
		game.move(m);
//		System.out.println("COMPLIST: Current player after AI makes a move: " + game.get_current_player());
//		JButton df = (JButton) e.getSource();
